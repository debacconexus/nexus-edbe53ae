...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "National Veterans Treatment Court Registry";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Court Reporting Period";
process.env.TABLE_NAME = process.env.TABLE_NAME || "court_reporting_period_records";
'use strict';
